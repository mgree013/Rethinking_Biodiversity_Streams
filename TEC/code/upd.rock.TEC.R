...
mod4<-glm(betas.LCBD~Spatial*E_PC1,family=gaussian(),data=all_big_dat)
mod5<-glm(betas.LCBD~Spatial*Com.Size.Gradient,family=gaussian(),data=all_big_dat)
mod6<-glm(betas.LCBD~E_PC1*Com.Size.Gradient,family=gaussian(),data=all_big_dat)
mod7<-glm(betas.LCBD~E_PC1*Com.Size.Gradient*Spatial,family=gaussian(),data=all_big_dat)
null<-glm(betas.LCBD~1,family=gaussian(),data=all_big_dat)
...
null<-glmmTMB(N1~ (1|O.NET),family=gaussian(),data=all_big_dat)
